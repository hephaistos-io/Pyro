...
==== Main
* Newest stable state of application
* Automatic deploy to a test environment

===== Restrictions
* no pushes or deletes
* pull requests required with min. 2 approvals
* only squash or rebase as operations possible

==== Feature Branch
* Are created from or linked to issues
* Are branched from main or parent feature branch

===== Restrictions
* Only get merged to main by pull request
